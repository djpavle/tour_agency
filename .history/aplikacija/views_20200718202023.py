    ...
    if request.method=="GET":
        ...
        if form.is_valid():
            ...
            if beds_available:
                ...
                try:
                    send_mail(f'Globe tour reservation to {tour_name}',email_message,'globetours011@gmail.com',[email],fail_silently=False)
                    ...
                    message =f'thank you {name} ! Your reservation to {tour} for {number_of_guests} guests , with a total price of {total_price} has been booked successfully. WE SENT YOU A MAIL WITH THE DETAILS BUT IT WAS RETURNED! PLEASE CHECK IF YOU ENTERED THE CORRECT ADDRESS'
                    return render(request,'aplikacija/home.html',{'msg':message,'top_three':top_three_destinations})
            else:
                form = ClientForm()
