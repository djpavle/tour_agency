...
urlpatterns = [
    ...
    path("reservationDetails/",views.reservationDetailView,name='reservation_details'),
    path("cancelReservation/",views.cancelReservationView,name='cancel_reservation')
